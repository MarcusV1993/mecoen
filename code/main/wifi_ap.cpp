/* This code has been adapted for specific use of the marcus's energy meter project
 *
   WiFi softAP Example
...
*/
#define EXAMPLE_ESP_WIFI_SSID      "energy_meter_ap"
#define EXAMPLE_ESP_WIFI_PASS      "standardpassword"
